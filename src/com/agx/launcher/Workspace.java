...
import com.agx.launcher.R;
import com.agx.launcher.FolderIcon.FolderRingAnimator;
import com.agx.launcher.LauncherSettings.Favorites;
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (LauncherApplication.isScreenLarge()) {
            ...
            try {
                ...
                maxDims.x = mLauncher.getWindowManager().getDefaultDisplay().getWidth();
                maxDims.y = mLauncher.getWindowManager().getDefaultDisplay().getHeight();
                minDims.x = mLauncher.getWindowManager().getDefaultDisplay().getWidth();
                minDims.y = mLauncher.getWindowManager().getDefaultDisplay().getHeight();
            }
    ...
    */
    ...
    static Rect getCellLayoutMetrics(Launcher launcher, int orientation) {
        ...
        try {
            ...
            smallestSize.x = display.getWidth();
            smallestSize.y = display.getHeight();
            largestSize.x = display.getWidth();
            largestSize.y = display.getHeight();
        }
